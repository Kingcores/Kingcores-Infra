...
class Common
{
    const MAX_LENGTH_EMAIL_ADDRESS = '320';
    const MAX_LENGTH_URL = '2083';
    ...
    private static $__statusCodeMessages;

    public static function getStatusCodeMessage($status)
    {
        if (!isset(self::$__statusCodeMessages))
        {
            self::$__statusCodeMessages = Array(
                100 => 'Continue',
        ...
        return self::$__statusCodeMessages[$status];
    }
}

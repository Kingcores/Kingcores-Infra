...
class Schema
{
    ...
    public function __construct($schemaName, array $schemaConfig)
    {
        ...
        $this->_features = $this->_schemaConfig[Convention::KEYWORD_SCHEMA_FEATURES];
    ...
    private function _loadEntity($sourceSite, $entityReference)
    {
        ...
        return ($this->_entityPool[$entityReference] = new Entity($this, $schemaSetName, $refEntityName, $entityConfig, $entityType));
    }
}

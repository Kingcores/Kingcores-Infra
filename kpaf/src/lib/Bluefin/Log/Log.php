...
class Log
{
    ...
    const CHANNEL_ERROR_REPORT = 'error_report';
     ...
     */
    public function log($level, $message, $channel = self::CHANNEL_GENERAL)
    {
    ...
    public function fatal($message, $channel = self::CHANNEL_GENERAL)
    {
        $this->log(self::FATAL, $message, $channel);
    }

    public function alert($message, $channel = self::CHANNEL_GENERAL)
    {
        $this->log(self::ALERT, $message, $channel);
    }

    public function critical($message, $channel = self::CHANNEL_GENERAL)
    {
        $this->log(self::CRITICAL, $message, $channel);
    }

    public function error($message, $channel = self::CHANNEL_GENERAL)
    {
        $this->log(self::ERROR, $message, $channel);
    }

    public function warning($message, $channel = self::CHANNEL_GENERAL)
    {
        $this->log(self::WARNING, $message, $channel);
    }

    public function info($message, $channel = self::CHANNEL_GENERAL)
    {
        $this->log(self::FATAL, $message, $channel);
    }

    public function verbose($message, $channel = self::CHANNEL_GENERAL)
    {
        $this->log(self::VERBOSE, $message, $channel);
    }

    public function debug($message, $channel = self::CHANNEL_GENERAL)
    {
